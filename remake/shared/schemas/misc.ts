...
export const DIR = {
	...
	SRC: `${baseDir}/src`,
	API: {
		MAIN: `${baseDir}/src/API`,
		REQUESTS: `${baseDir}/src/API/requests`,
		TESTS: `${baseDir}/src/API/tests`,
	},
	DB: `${baseDir}/src/db`,
	SHARED: {
		MAIN: `${baseDir}/src/shared` as string,
		SHARED_SCHEMA: `${baseDir}/src/shared/schemas`,
		SHARED_UTILS: `${baseDir}/src/shared/utils`,
	},
} as const;
